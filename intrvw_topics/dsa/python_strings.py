...
print("Original Greeting statement: "+greeting_statement)
...
print("greeting_statement[:2]: (Displays the string from first character till index 2 (ie, third character)::"+greeting_statement[0:2])
